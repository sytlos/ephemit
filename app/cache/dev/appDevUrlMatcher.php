...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // ephemit_calendrier_homepage
        if ($pathinfo === '/calendrier') {
            return array (  '_controller' => 'Ephemit\\CalendrierBundle\\Controller\\CalendrierController::indexAction',  '_route' => 'ephemit_calendrier_homepage',);
        }

        // ephemit_evenement_creer
        if ($pathinfo === '/page/creer') {
            return array (  '_controller' => 'Ephemit\\EvenementBundle\\Controller\\EvenementController::creerAction',  '_route' => 'ephemit_evenement_creer',);
        }

        if (0 === strpos($pathinfo, '/mes-pages')) {
            // ephemit_evenement_list
            if ($pathinfo === '/mes-pages') {
                return array (  '_controller' => 'Ephemit\\EvenementBundle\\Controller\\EvenementController::listeAction',  '_route' => 'ephemit_evenement_list',);
            }

            // ephemit_evenement_supprimer
            if (0 === strpos($pathinfo, '/mes-pages/supprimer') && preg_match('#^/mes\\-pages/supprimer/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
        ...
        if (0 === strpos($pathinfo, '/favoris/ajouter') && preg_match('#^/favoris/ajouter/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
        ...
        if (rtrim($pathinfo, '/') === '') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'ephemit_site_homepage');
            }

            return array (  '_controller' => 'Ephemit\\SiteBundle\\Controller\\SiteController::indexAction',  '_route' => 'ephemit_site_homepage',);
        }

        // ephemit_site_search
        if ($pathinfo === '/search') {
            return array (  '_controller' => 'Ephemit\\SiteBundle\\Controller\\SiteController::searchPageAction',  '_route' => 'ephemit_site_search',);
        }

        // ephemit_utilisateur_homepage
        if (0 === strpos($pathinfo, '/hello') && preg_match('#^/hello/(?P<name>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'ephemit_utilisateur_homepage')), array (  '_controller' => 'Ephemit\\UtilisateurBundle\\Controller\\DefaultController::indexAction',));
        }
